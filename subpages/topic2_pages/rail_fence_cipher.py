...
class Rail_fence_cipher:
    ...
    def rail_fence_cipher_page():
        global plaintext_error, ciphertext_error, key_error, key_input, plaintext_input, ciphertext_input
    ...
    # ? Button Frame
        ...
        Button(
            ...
            command=lambda: Rail_fence_cipher.encrypt_data()).grid(row=0, column=0, padx=10, pady=10)
        Button(
            button_frame,
            text="Decrypt",
            font=(font_family, 12),
            background=button_colour,
            command=lambda: Rail_fence_cipher.decrypt_data()).grid(row=0, column=1, padx=10, pady=10)
    # ?
    # ? Error Frame
